        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-header">
                    <h3>Add Product
                        <a href="{{ url('admin/product') }}" class="btn btn-primary float-end btn-sm text-white">Back
                            Product</a>
                    </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="md-3">
                                            ...
                                            <input type="checkbox" style="width: 50px;,height=50px;" name="trending">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="md-3">
                                            <label for="trending">Featured</label>
                                            <input type="checkbox" style="width: 50px;,height=50px;" name="featured">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="md-3">
