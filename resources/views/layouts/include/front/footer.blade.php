<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">Hatela E-Commerce</h4>
                    <div class="footer-underline"></div>
                    <p>
                        Hatela Ecom is an e-commerce website that provides a platform for individuals and businesses to
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-phone"></i> +977 688-XXX-XXXX
                        </a>
                    </div>
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> hatelaecom@gmail.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - Hatela o - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
