        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name"> HaTeLa Ecom</h5>
                </div>
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('wishlist')}}">
                                <i class="fa fa-heart"> Wishlist (<livewire:frontend.wishlist-count/>)</i>
                                {{-- Wishlist (0) change for live count  --}}
                            </a>
                        </li>
                        @guest
                            @if (Route::has('login'))
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/collection">All Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/new_arrival">New Arrivals</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="featured_product">Featured Products</a>
                    </li>
                    <li class="nav-item">
