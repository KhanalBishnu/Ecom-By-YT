            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                        ...
                        {{-- change name=wire:model for sent the attribute in livewire and sent the button to wire:click="" fro function to uptimization --}}
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab"
                                                ...
                                                <hr />
                                                <button type="button" wire:click="codOrder"wire:loading.attr="disabled"
                        ...
                        @else
                            No Item To Cart | <a class="text-primary"href="{{ url('/collection') }}">Shop Now!</a>
                        @endif
